<h3> Дипломная работа по модулю "Основы Python" (учебный курс Нетологии) </h3>
...
2. Постановка и проверка статистических гипотез (t-критерий Стьюдента, U-критерий Манна-Уитни).<br>
